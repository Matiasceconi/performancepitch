...
export default function AiScheduleImportModal({ open, onClose, activeSquad, activeSquadId, activeSeasonId, onImported }) {
  ...
  async function confirmImport() {
    ...
    if (!validEvents.length || !activeSquadId) return;
    setSaving(true);
    try {
