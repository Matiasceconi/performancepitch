// Mapa canónico de escudos de clubes argentinos.
// Fuente única para poblar RivalClub.shield_url durante la migración.
// Extraído de Matches.jsx para reutilizar en toda la plataforma.

export const CLUB_SHIELDS = {
  ...
  "central córdoba de santiago del estero": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/e18f29c5d_centralcordoba.png",
  ...
  "estudiantes de la plata": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/3a3706975_estudiantes.png",
  ...
  "gimnasia de mendoza": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/9488b9e24_gimnasiamendoza.png",
  ...
  "vélez sarsfield": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/973c619a4_velez.png",
  ...
  "san martin de san juan": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/03e039b58_sanmartinsj.png",
  "san martín de san juan": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/03e039b58_sanmartinsj.png",
  ...
  "atlético de rafaela": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/a105893ba_atleticorafaela.png",
  "atletico de rafaela": "https://media.base44.com/images/public/6a3bc03033558cd65ec27f53/a105893ba_atleticorafaela.png",
};

export function normalizeShieldKey(str) {
  return (str || "").toLowerCase().trim()
    .normalize("NFD").replace(/[\u0300-\u036f]/g, "")
    .replace(/['']/g, "");
}

export function getShieldForName(name) {
  if (!name) return null;
  const key = normalizeShieldKey(name);
  for (const [k, v] of Object.entries(CLUB_SHIELDS)) {
    if (normalizeShieldKey(k) === key) return v;
  }
  return null;
}